...
export async function sendPageLoadXapi(pageTitle: string) {
  ...
  const statement = {
    ...
    object: {
      id: "https://academyproduct.github.io/interactive_ampol_completion_guide/",
      definition: {
...
export async function sendCheckboxXapi(ctx: CheckboxXapiContext) {
  ...
  const statement = {
    ...
    object: {
      ...
      id: `https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/task/${task.id}`,
      definition: {
    ...
    context: {
      contextActivities: {
        parent: [
          {
            id: `https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/week/${weekNumber}/day/${dayKey}`,
            definition: {
      ...
      extensions: {
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/weekNumber": weekNumber,
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/dayKey": dayKey,
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/taskId": task.id,
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/module": task.module,
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/unit": task.unit,
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/page": task.page,
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/activity_type": task.activity_type,
      },
    },
    timestamp: new Date().toISOString(),
  };
...
function getActor() {
  ...
  return {
    account: {
      homePage: "https://academyproduct.github.io/interactive_ampol_completion_guide/", /* this homePage is a static string and can be adjusted, example: https://academyproduct.github.io/interactive_ampol_completion_guide/*/
      name: userId,
    },
  };
}
...
export async function sendCompletionDateXapi(completionDate: string) {
  ...
  const statement = {
    ...
    verb: VERBS.selected,
    object: {
      id: "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ui/completion-date",
      definition: {
    ...
    context: {
      extensions: {
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/completionDate": completionDate,
      },
    },
    timestamp: new Date().toISOString(),
  };
...
export async function sendScheduleDaySelectionXapi(dayKey: DayKey, selected: boolean) {
  ...
  const statement = {
    ...
    verb,
    object: {
      id: "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ui/schedule/day-selection",
      definition: {
    ...
    context: {
      extensions: {
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/dayKey": dayKey,
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/selected": selected,
      },
    },
    timestamp: new Date().toISOString(),
  };
...
export async function sendScheduleMinutesXapi(dayKey: DayKey, minutes: number) {
  ...
  const statement = {
    ...
    verb: VERBS.selected,
    object: {
      id: "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ui/schedule/minutes",
      definition: {
    ...
    context: {
      extensions: {
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/dayKey": dayKey,
        "https://academyproduct.github.io/interactive_ampol_completion_guide/xapi/ext/minutes": minutes,
      },
    },
    timestamp: new Date().toISOString(),
  };
